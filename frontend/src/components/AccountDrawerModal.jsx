            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200 text-[10px] font-black uppercase tracking-wider flex items-center gap-1">
                  <Sparkles className="w-3 h-3 text-emerald-600" /> Clinical AI Matrix
                </span>
              </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-slate-800">
          ...
          <div className="p-3.5 rounded-2xl bg-emerald-50/70 border border-emerald-200 text-slate-700 space-y-1">
            <div className="flex items-center gap-1.5 font-bold text-xs text-emerald-800">
              ...
              <span>NutriMenu Clinical Intelligence Engine Active</span>
            </div>
            <p className="text-[11px] text-slate-600 leading-relaxed">
              Biometrics, medical conditions, and strict allergens are analyzed directly by the deterministic clinical nutrition engine to synthesize your risk vectors and 3-tier recommendation fit scores.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center gap-2">
            {savedFeedback ? (
              <span className="text-xs font-bold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-200 flex items-center gap-1">
                <Check className="w-3.5 h-3.5 stroke-[2.5]" /> Matrix Synced & Active!
              </span>
            ) : (
              <span className="text-xs text-slate-500 flex items-center gap-1">
                <BrainCircuit className="w-3.5 h-3.5 text-emerald-600" />
                {loadingMatrix ? 'Synthesizing Clinical Matrix...' : 'Live metric preview active'}
              </span>
            )}
          </div>
